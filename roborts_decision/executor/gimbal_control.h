...
/**
 * @brief The class can make a transformation: the 3D position of enemy -->
 * pitch,yaw angle of gimbal. For more derails, see projectile_model.pdf
...
public:
  /**
   * @brief Init the Transformation matrix from camera to gimbal //TODO: write
   * in ros tf
   * @param x Translate x
   * @param y Translate y
   * @param z Translate z
   ...
   */
  void Init(float x, float y, float z, float pitch, float yaw, float init_v,
            float init_k);
